...
public class SystemWebChromeClient extends WebChromeClient {
    ...
    public void onProgressChanged(WebView view, int newProgress) {
    	...
    	if(newProgress == 100) {
    		...
    		//parentEngine.getView().setVisibility(View.VISIBLE);
    		CordovaActivity.mVideoProgressView.setVisibility(View.GONE);
    	} /*else if(newProgress<=40){
    		parentEngine.getView().setVisibility(View.VISIBLE);
    		CordovaActivity.mVideoProgressView.setVisibility(View.VISIBLE);
    	} */else {
    		//parentEngine.getView().setVisibility(View.GONE);
    		CordovaActivity.mVideoProgressView.setVisibility(View.VISIBLE);
    	}
    } 
}
