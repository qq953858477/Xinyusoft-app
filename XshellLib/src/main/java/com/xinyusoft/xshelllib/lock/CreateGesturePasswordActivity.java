...
import com.xinyusoft.xshelllib.view.LockPatternView.DisplayMode;
...
public class CreateGesturePasswordActivity extends Activity implements
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.xinyusoft_gesturepassword_create);
		// 初始化演示动画
	...
	private void updatePreviewViews() {
		...
		for (LockPatternView.Cell cell : mChosenPattern) {
			...
			mPreviewViews[cell.getRow()][cell.getColumn()]
					.setBackgroundResource(R.drawable.xinyusoft_gesture_create_grid_selected);
	...
	private void saveChosenPatternAndFinish() {
		AppContext.APPCONTEXT.getLockPatternUtils().saveLockPattern(mChosenPattern);
		showToast("密码设置成功");
