package com.xinyusoft.xshelllib.tools.download;//package com.xinyusoft.xshell.tools.download;
//
//import java.io.File;
//
...
//		if (url == null || PreferenceUtil.getInstance().getAppUpdateTime() == null
//				|| "".equals(PreferenceUtil.getInstance().getAppUpdateTime()) || "".equals(url)) {
//			checkH5();
//			return;
//		}
//		http.send(HttpRequest.HttpMethod.GET, url + PreferenceUtil.getInstance().getAppUpdateTime(),
