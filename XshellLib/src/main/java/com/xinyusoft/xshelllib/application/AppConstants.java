...
public class AppConstants {
	...
	public static final boolean WEIXIN_SHARE_FRIEND = true;// 分享到朋友圈
	public static final String ACTION_LANDSCAPE = "action_landscape"; // 强制横屏

	public static final String ACTION_PORTRAIT = "action_portrait";// 强制竖屏
	// app的log存放地址
	...
	// 跳转新的activity
	public static final String JUMP_SECOND = "JUMP_SECOND";
	// 关闭当前activity
