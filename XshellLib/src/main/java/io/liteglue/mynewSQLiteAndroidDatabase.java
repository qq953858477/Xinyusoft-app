 ...
 */
class mynewSQLiteAndroidDatabase
{
    ...
    void executeSqlBatch(String[] queryarr, JSONArray[] jsonparams,
        ...
        for (int i = 0; i < len; i++) {
            ...
            try {
                ...
                if (needRawQuery) {
                    queryResult = this.executeSqlStatementQuery(mydb, query, jsonparams[i]);
        ...
        if (queryType == QueryType.update) {
            ...
            if (tableMatcher.find()) {
                ...
                try {
                    ...
                    Log.e(mynewSQLiteAndroidDatabase.class.getSimpleName(), "uncaught", e);
                }
            }
        } else { // delete
