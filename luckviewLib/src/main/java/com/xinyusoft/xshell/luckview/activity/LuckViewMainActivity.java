 ...
 * 大转盘主类
 */
public class LuckViewMainActivity extends Activity implements OnClickListener {
    /**
     * 自定义转盘控件
     */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FulStatusBarUtil.setcolorfulStatusBarMain(this);
            ...
            public void onResponse(String s) {
                try {
                    ...
                    if (object.has("datalist")) {
                        ...
                        mStartBtn.setEnabled(true);
                        //有数据之后才设置监听
                        mLuckyPanView.setOnClickListener(LuckViewMainActivity.this);
                        if (animator != null) {
                            animator.cancel();
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.id_start_btn) {
            ...
            intent.putExtra("userId", userId);
            intent.putExtra("ipUrl", ipUrl);
            intent.putExtra("isChangeStock", startBtnType);
